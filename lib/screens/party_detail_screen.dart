...
class PartyDetailScreen extends StatelessWidget {
  ...
  Future<void> _shareInvoice(
    ...
    try {
      // Show a brief loading indicator while generating
      ...
      messenger.showSnackBar(
        const SnackBar(
          ...
          duration: Duration(seconds: 30), // dismissed manually below
        ),
      );
          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                onPressed: () => _shareInvoice(context, vehicles, transactions),
              ),
            ],
          ),
                ...
                if (vehicles.isEmpty)
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final vehicleTransactions = transactions
